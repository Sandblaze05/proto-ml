...
/**
 * @typedef {Object} WarningGraphicProps
 * @property {number} [width] - Width of the graphic
 * @property {number} [height] - Height of the graphic
 * @property {string} [className] - Additional CSS classes
 * @property {boolean} [enableAnimations] - Control animation enable/disable
 * @property {number} [animationSpeed] - Animation speed multiplier
 * @property {string} [color] - Color override for all elements
 */

/**
 * @param {WarningGraphicProps} props
 */
export function WarningGraphic({
  ...
  animationSpeed = 1,
  color = "#faebd7", // Updated to Antique White to match proto-ML brand
}) {
