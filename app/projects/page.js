  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      if (user) {
        ...
        // Fetch pipelines shared directly with my email
    ...
    <div className="min-h-screen bg-background text-foreground font-mono p-8">
      <div className="max-w-6xl mx-auto">
        <header className="flex justify-between items-center mb-12 border-b border-foreground/10 pb-6">
          ...
          <Link href="/dashboard" className="px-6 py-2 bg-foreground text-background font-bold rounded-full hover:opacity-90 transition-all">
            New Canvas
          </Link>
        </header>
